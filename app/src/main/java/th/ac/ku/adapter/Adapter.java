...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String ads_tv = orderRecycleList.get(position).getAds_tv();
        holder.setData(resource,orderNo,serviceTv,pickordropTv,droporPickTime,statusNow_tv,ads_tv) ;
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public TextView orderNo,serviceTv,pickordropTv,droporPickTime,statusNow_tv,ads_tv ;
        ...
        public ViewHolder(@NonNull View itemView, OnNoteListener onClickListener) {
            ...
            droporPickTime =  itemView.findViewById(R.id.quantityTv) ;
            statusNow_tv =  itemView.findViewById(R.id.statusNow_tv) ;
            ads_tv = itemView.findViewById(R.id.ads_tv);
            this.onNoteListener = onClickListener;
            itemView.setOnClickListener(this);
        }
        public void setData(int resource, String orderNo,String serviceTv,String pickordropTv, String droporPickTime, String statusNow_tv,String ads_tv){
